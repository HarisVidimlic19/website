...
(function ($) {
  ...
  $.getJSON('./data/data.json', function (data) {
    ...
    var scaleFactor = 12; // Adjust this to your desired scale
    ...
    jQuery.each(data, function (i, val) {
      ...
      var majorAxisInPixels = 2 * A * scaleFactor;
      var minorAxisInPixels = A * Math.sqrt(1 - ec ^ 2) * scaleFactor;
      var scaleX = majorAxisInPixels / 2; // Half the major axis length
      var scaleY = minorAxisInPixels / 2; // Half the minor axis length
...
//# sourceMappingURL=main.a4ec744d.js.map