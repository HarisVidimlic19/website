...
(function ($) {
  ...
  $.getJSON('./data/data.json', function (data) {
    ...
    // context.rotate(Math.PI/2); // Rotate 90 degrees clockwise (natural orientation for canvas is upside down)
    ...
    jQuery.each(data, function (i, val) {
      ...
      var semiminorAxis = semimajorAxis * Math.sqrt(1 - ec ^ 2);
      ...
      var c = A * ec * scaleFactor;
      var fociX = c * Math.sin(W);
      var fociY = -c * Math.cos(W);
      ...
      // // Draw ellipse centered between foci points
      // context.beginPath();
      // context.ellipse(xCenter, yCenter, semimajorAxis, semiminorAxis, 0, 0, 2 * Math.PI);
      // context.strokeStyle = color;
      // context.stroke();
...
//# sourceMappingURL=main.1e7b25cc.js.map