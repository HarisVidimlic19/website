...
(function ($) {
  ...
  var scraper = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var url, proxyUrl, response, htmlString, parser, doc, container;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            url = 'https://phys.org/physics-news/sort/popular/1w/'; // const proxyUrl = 'https://cors-anywhere.herokuapp.com/';
            proxyUrl = 'https://proxy-server-gspl.onrender.com/';
            _context.next = 4;
          ...
          case 7:
            ...
            container = doc.querySelector('.sorted-news-list');
  ...
  $.getJSON('./data/data.json', function (data) {
    // Find the canvas and its context
    ...
    context.translate(centerCanvasX, centerCanvasY); // Set origin to center
    context.rotate(-Math.PI / 2); // Rotate 90 degrees clockwise (270 degrees counter-clockwise)
    ...
    jQuery.each(data, function (i, val) {
      ...
      var semimajorAxis = A * scaleFactor;
      var semiminorAxis = A * Math.sqrt(1 - ec ^ 2) * scaleFactor;
      var scaleX = semimajorAxis; // Half the major axis length
      var scaleY = semiminorAxis; // Half the minor axis length

      // // Calculate distance between foci points in pixels
      // const c = A * ec * scale;

      // // Calculate second foci point's coordinates in pixels
      // const fociX = scaleX
      // const fociY = scaleY;

      // // Draw ellipse centered between foci points
      // context.beginPath();
      // context.ellipse(fociX, fociY, semimajorAxis, semiminorAxis, 0, 0, 2 * Math.PI);
      ...
      // Approximate the ellipse using two Bézier curves
      context.bezierCurveTo(scaleX, -scaleY, -scaleX, -scaleY, -scaleX, 0);
      context.bezierCurveTo(-scaleX, scaleY, scaleX, scaleY, scaleX, 0);
      context.closePath();
      context.restore();
      context.strokeStyle = color;
...
//# sourceMappingURL=main.f4e5d54b.js.map